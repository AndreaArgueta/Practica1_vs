...
int main() {
    ...
    //SYSCTL->RCGCGPIO |= (1<<12)|(1<<8)|(1<<5)|(1<<1);
                        //operación con hexadecimal 
    SYSCTL->RCGCGPIO |= 0x1122;     //1 0001 0010 0010
...
/*esto es una actualizacion*/
  ...
  while (1U)
  {
        ...
        // Delay for a bit.
        //
        for(ui32Loop = 0; ui32Loop < 1000000; ui32Loop++) //Aumenta la velocidad 
        {
        }
        //
        // Turn off the LED.
        ...
        // Delay for a bit.
        //
        for(ui32Loop = 0; ui32Loop < 100000; ui32Loop++) //Aumenta la velocidad 
        {
        }
                GPION->DATA &= ~(0x02);
        //GPIO_PORTN_DATA_R &= ~(0x01);
